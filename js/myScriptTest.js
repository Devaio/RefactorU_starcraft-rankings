...
//End Bootstrap pagination
	...
	$('#starTable').html('<table cellpadding="0" cellspacing="0" border="0" class="display" id="starTable"></table>');
	var starRender = {
		"aaData": starData,
		"aoColumns": [
		{"sTitle" : "Username",},
...
//Begin custom info @ bottom of table based on sort
// starRender.fnInfoCallback = function( oSettings, iStart, iEnd, iMax, iTotal, sPre ) {
//    return "Showing aa through eg";
// }
// $('#starTable').dataTable({
// 	"bFilter": false,
// 	"destroy":true
